...
import './SokuhoSelectTournament.css'
...
export const Input_Tournament = () => {
  ...
  return (
    <div>
      ...
      <div class="selectdiv_So_SoTo">

        <label>
          <select ref={birthYearRef} value={birthYear} onChange={selectBirthYear}></select>
        </label>
      </div>
      <div class="moji">
          年
      ...
      <div class="selectdiv_So_SoTo">
        <label>
          <select ref={birthMonthRef} value={birthMonth} onChange={selectBirthMonth}></select>
        </label>
      </div>
      <div class="moji">
          月

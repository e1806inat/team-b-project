        ...
        <>
            ...
            <div className="MakeGame">
                <div class="whole_Sokuhou">
                    ...
                    {makePulldown(0, iningList, "ining", nowSelected, setNowSelected)}回戦<br />
                    ...
                    会場{makePulldown(3, Venues, "venue_name", nowSelected, setNowSelected)}<br /><br />
                
                    <button class="btn_So_Make" onClick={() => handleAddGame(
                        urlTournamentId,
                        nowSelected,
                        iningList,
                        Schools,

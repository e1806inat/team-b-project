  ...
  return (
    ...
    <div className="updateArea">
      <div className="updateButton">
        <input id="automaticUpdate" class="radiobutton" name="hoge" type="radio" value="自動更新" />
        <label for="automaticUpdate">自動更新</label>
        <input id="manualUpdate" class="radiobutton" name="hoge" type="radio" value="手動更新" checked />
        <label for="manualUpdate">手動更新</label> 
      </div>

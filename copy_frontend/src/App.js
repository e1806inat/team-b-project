...
import { Top, Login, TodoList, Home, Input_mode, Pre_Input, InputSchool, Input_Tournament, InputMember, Sokuho_Input_Makegame, InputPlayGame, NotFound, TournamentNamber} from './components/index';

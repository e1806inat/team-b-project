export const Ground = (context) => {
    ...
    context.arc(homebase+l, homebase + h, homebase + margin * 7, -Math.PI / 5, 6 * Math.PI / 5, true);
    context.closePath();
    context.fill();
    ...
    context.moveTo(homebase+l, homebase + h);
    context.arc(homebase+l, homebase + h, homebase + margin, -Math.PI / 5, 6 * Math.PI / 5, true);
    context.closePath();
    context.fill();
    ...
    context.moveTo(homebase+l, homebase + h);
    context.arc(homebase+l, homebase + h, homebase, -Math.PI / 5, 6 * Math.PI / 5, true);
    context.closePath();
    context.fill();
    ...
    context.moveTo(homebase+l, homebase + h);
    context.arc(homebase+l, homebase + h, 3.5 * homebase / 5, -Math.PI / 5, 6 * Math.PI / 5, true);
    context.closePath();
    context.fill();
    ...
    context.beginPath();
    context.moveTo(homebase+l,homebase+h);
    context.lineTo(homebase - homebase / Math.sqrt(2)+l, homebase + h - homebase / Math.sqrt(2))
